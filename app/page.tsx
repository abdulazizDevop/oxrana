  ...
  return (
    <>
      <div style={{
        ...
        <Background />
        {/* Full reset escape hatch — wipes SW, caches, localStorage, sessionStorage, cookies and IndexedDB */}
        <button onClick={async () => {
          ...
          style={{ position: "fixed", top: "max(14px, env(safe-area-inset-top, 14px))", right: 14, zIndex: 9999, width: 38, height: 38, borderRadius: 12, border: "1px solid rgba(239,68,68,0.35)", background: "rgba(239,68,68,0.15)", color: "#f87171", fontSize: 16, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", backdropFilter: "blur(12px)" }}>
          ↻
        </button>
