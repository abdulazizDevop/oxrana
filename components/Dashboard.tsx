...
function getSectionMap(city: string, companyId?: string, currentUser?: AppUser): Record<string, React.ReactNode> {
  return {
    ...
    photo:         <PhotoReportSection city={city} companyId={companyId} currentUser={currentUser} />,
    ...
    fines:         <FinesSection city={city} companyId={companyId} currentUser={currentUser} />,
